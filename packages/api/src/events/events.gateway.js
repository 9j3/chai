...
var EventsGateway = /** @class */ (function () {
    ...
    EventsGateway.prototype.doStuff = function (data, client) {
        client.emit('hello', { date: Date.now() });
    };
    EventsGateway.prototype.identity = function (data) {
    ...
    ], EventsGateway.prototype, "doStuff");
    __decorate([
        (0, websockets_1.SubscribeMessage)('identity'),
        __param(0, (0, websockets_1.MessageBody)())
    ], EventsGateway.prototype, "identity");
