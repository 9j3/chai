...
describe('E2E Login', function () {
    ...
    it('should get a JWT then successfully make a call', function () { return __awaiter(void 0, void 0, void 0, function () {
        var loginReq, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    loginReq = _a.sent();
                    token = loginReq.body.data.payload.token;
    ...
    it('should not login due to wrong password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app.getHttpServer())
                        .post('/api/auth/login')
    ...
    it('should not login due to wrong username', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app.getHttpServer())
                        .post('/api/auth/login')
...
describe('E2E Register', function () {
    ...
    it('should not register due to username already exists', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app.getHttpServer())
                        .post('/api/auth/register')
